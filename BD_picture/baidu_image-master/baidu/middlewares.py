...
class ChromeSpiderMiddleware(object):
    ...
    def __init__(self):
        ...
        print("初始化浏览器")
        self.browser = webdriver.Chrome(executable_path="C:\\Program Files "
                                                        "(x86)\\Google\\Chrome\\"
                                                        "Application\\chromedriver",chrome_options=option)
    ...
    def process_request(self, request, spider):
        ...
        if request.meta.get("is_image"):
            ...
            if request.meta.get("is_detail"):
                ...
                wait.until(lambda browser:browser.find_element_by_xpath('//img[@id="currentImg"]')
